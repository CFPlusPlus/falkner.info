...
export const socialLinks = [
  ...
  { label: "LinkedIn", href: "https://www.linkedin.com/in/christian-falkner-60a45537b/" },
  { label: "GitHub", href: "https://github.com/CFPlusPlus" },
  { label: "Steam", href: "https://steamcommunity.com/id/lestructor" },
  { label: "Xbox", href: "https://account.xbox.com/de-DE/Profile?gamerTag=QuickChrissi" }
] as const;
...
export const projects: Project[] = [
  {
    title: "falkner.info",
    summary: "Meine private Webseite – ein kompaktes Zuhause für Einblicke, Links und Projekte.",
    tags: ["Personal", "Web"],
  ...
  },
  {
    ...
    summary: "Community, in der Spaß und Zusammenhalt zählen – ein Ort, an dem man gerne abhängt.",
  ...
  },
  {
    ...
    summary: "Eigene Systeme zusammenbauen, reparieren und optimieren – einfach weil Technik Spaß macht.",
